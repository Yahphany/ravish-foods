          ...
          <div className="w-[68px] h-[68px] bg-[#F24E05] rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(242,78,5,0.2)] transition-transform duration-300 hover:scale-105 hover:rotate-6">
            <svg viewBox="0 0 100 100" className="w-9 h-9">
              ...
              <g transform="translate(50,50) rotate(-45) translate(-50,-50)">
                <path d="M47,20 C47,20 49,25 49,38 L49,55 L45,55 L45,20 Z" fill="white" />
                <rect x="45.5" y="58" width="3" height="22" rx="1.5" fill="white" />
                <rect x="44.5" y="55" width="5" height="3" rx="0.5" fill="white" />
              </g>
              {/* Fork */}
              <g transform="translate(50,50) rotate(45) translate(-50,-50)">
                <path d="M48,38 L52,38 L51,55 L49,55 Z" fill="white" />
                <path d="M45,20 L45,35 C45,38 55,38 55,35 L55,20" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="48.3" y1="20" x2="48.3" y2="35" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="51.7" y1="20" x2="51.7" y2="35" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
                <rect x="48.5" y="58" width="3" height="22" rx="1.5" fill="white" />
                <rect x="47.5" y="55" width="5" height="3" rx="0.5" fill="white" />
              </g>
            </svg>
          </div>
        </div>

        <h1 className="text-[28px] font-semibold text-gray-800 tracking-tight mb-2">Create Account</h1>
        <p className="text-sm text-gray-500 mb-8">Sign up to get started on RAVISH</p>
