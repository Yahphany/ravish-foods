...
export default function Dashboard() {
  ...
  if (session === undefined || (ordersLoading && orders.length === 0)) {
    return (
      <Layout>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm border border-black/[0.03] transition-all duration-300 hover:shadow-md">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                <div className="inline-flex items-center gap-2 bg-[#F24E05]/10 text-[#F24E05] px-3.5 py-1 rounded-full text-xs font-semibold uppercase tracking-wide mb-3">
                  Customer Dashboard
                </div>
            ...
            {activeOrders.length === 0 ? (
              ...
              <div className="space-y-6">
                {activeOrders.map((order) => {
                  const statusSteps = ["Pending", "Preparing", "Out for Delivery"];
