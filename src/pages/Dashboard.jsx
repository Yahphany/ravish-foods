...
export default function Dashboard() {
  ...
  const { orders, ordersLoading, cancelOrder, reorder } =
  ...
  const handleReorderClick = (order) => {
    reorder(order);
    setFeedbackMsg(
      `Added items from ${displayOrderId(order.id)} back to your cart!`,
    );
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  {userRole === "vendor"
                    ? "Publish your food menu options and package incoming orders in real-time."
                    : userRole === "logistics"
                      ? "Find shipping routes, accept packages, and complete customer deliveries."
                ...
                {activeOrders.length === 0 ? (
                  <div className="text-center py-10 flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1 mb-5">
                      Place an order from our menu and track it here in
                      real-time.
                    </p>
                    <button
                      type="button"
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 pb-4 mb-5">
                            ...
                            <div className="text-right sm:text-right text-left">
                              ...
                              <p className="text-lg font-black text-[#F24E05] mt-0.5">
                            ...
                            <div className="relative flex items-center justify-between w-full">
                              ...
                              {statusSteps.map((step, idx) => {
                                ...
                                return (
                                  <div
                                    key={idx}
                                    className="flex flex-col items-center bg-[#FDF5ED] sm:bg-white rounded-full p-1 border border-transparent"
                                  >
                                    <div
                                      className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                                        isCompleted
                                          ? "bg-[#F24E05] text-white"
                                          : isActive
                                            ? "bg-white border-2 border-[#F24E05] text-[#F24E05] scale-110 shadow-md"
                          ...
                          {order.status === "Out for Delivery" && (
                            <div className="flex justify-end pt-2">
                              <button
                                ...
                                className="text-xs font-bold text-white bg-[#F24E05] hover:bg-[#D94100] rounded-full px-5 py-2 transition-all cursor-pointer flex items-center gap-1.5 shadow-sm hover:shadow-orange-500/20"
                              >
                    ...
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-gray-100 text-xs font-bold uppercase tracking-wider text-gray-400">
                          ...
                          <th className="py-4 font-semibold text-right">
                            Total
                          </th>
                        ...
                        {pastOrders.map((order) => (
                          ...
                          >
                            ...
                            <td className="py-4 text-center whitespace-nowrap">
                              <span
                                className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-bold leading-5 ${
